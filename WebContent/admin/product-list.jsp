...
<body>
	...
	<div class="x-body">
		<form class="layui-form x-center" action="productsimplsearch.do" style="width: 800px">
		...
		<button class="layui-btn"
			onclick="member_add('添加用户','productload.do','600','500')">
		...
		<table class="layui-table">
			...
			<c:forEach var="product" items="${products}">
				<tr>
					...
					<a title="删除" href="userdelete.do?id=${user.id }" onclick="member_del(this,'1')"
